...
with(sData, plot(sData$DateTime,  as.numeric(as.character(sData$Global_active_power)), type = "l", ylab = "Global Active Power", xlab = ""))
...
with(sData, plot(sData$DateTime,  as.numeric(as.character(sData$Global_reactive_power)), type = "l", ylab = "Global_reactive_power", xlab = "datetime"))
